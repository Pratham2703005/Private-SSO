...
VALUES (
  'client-c-dev',
  'test_secret_hash_c',
  'Client App C Development',
  ARRAY['http://localhost:3003/api/auth/callback', 'http://localhost:3003/login'],
  true
)
ON CONFLICT (client_id) DO NOTHING;
...
WHERE client_id IN ('client-a', 'client-b', 'client-c-dev', 'client-inactive');
